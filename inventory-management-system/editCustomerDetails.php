    ...
    echo "
        <div class='container'>
            <form action='editCustomerDetails.php' method=POST>
                ...
                <div class = 'row' style='margin-top:25px'>
                    <label for='customer_adress'>customer Adress</label>
                    <input type='text' class='form-control' name='customer_adress' id='customer_adress' aria-describedby='adressHelp'value='$customer_adress' required>
                </div>
                <div class = 'row' style='margin-top:25px'>
                    <label for='customer_phone'>customer phone</label>
                    <input type='text' class='form-control' name='customer_phone' id='customer_phone' aria-describedby='adressHelp'value='$customer_phone' required>
                </div>
                <div class = 'row' style='margin-top:25px'>
                    <label for='customer_gender'>customer gender</label>
                    <input type='text' class='form-control' name='customer_gender' id='customer_gender' aria-describedby='adressHelp'value='$customer_gender' readonly required>
                </div>
                <div class = 'row' style='margin-top:25px'>
                    <label for='total_expenditure'>customer total expenditure</label>
                    <input type='text' class='form-control' name='total_expenditure' id='total_expenditure' aria-describedby='adressHelp'value='$total_expenditure' readonly required>
                </div>
                <div class = 'row' style='margin-top:25px'>
...
if(isset($_POST['update'])){
    ...
    $customer_update_query = "UPDATE customer SET customer_name = '$customer_name', customer_phone = '$customer_phone', customer_adress= '$Adress' WHERE id = '$customer_id'";
